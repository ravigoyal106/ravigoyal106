...
|---|---|
| **Compute & Networking** | EC2, VPC, ALB, Auto Scaling, Route 53, ELB, Lambda |
| **Security & IAM** | IAM Roles & Policies, Security Groups, NACLs, KMS|
| **Storage** | S3, EBS, EFS, Glacier |
| **Database** | RDS, DynamoDB |
| **Monitoring & Management** | CloudWatch, CloudTrail, AWS Config, Systems Manager |
| **IaC & Tools** | Terraform (learning), AWS CLI, Git, Linux, Bash |
...
- Applied least-privilege Security Groups across all tiers
...
<!--
**ravigoyal106/ravigoyal106** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
